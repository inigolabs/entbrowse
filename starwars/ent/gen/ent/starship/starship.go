...
const (
	// Label holds the string label denoting the starship type in the database.
	Label = "starship"
	...
	FieldCrew = "crew"
	// FieldHyperdriveRating holds the string denoting the hyperdrive_rating field in the database.
	FieldHyperdriveRating = "hyperdrive_rating"
	...
	// FieldMaximumMegalights holds the string denoting the maximum_megalights field in the database.
	FieldMaximumMegalights = "maximum_megalights"
...
var Columns = []string{
	...
	FieldCostInCredits,
	FieldCrew,
	FieldHyperdriveRating,
	FieldLength,
	FieldManufacturer,
	FieldMaxAtmospheringSpeed,
	FieldMaximumMegalights,
	FieldModel,
	FieldName,
