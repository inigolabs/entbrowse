...
type FilmFunc func(context.Context, *ent.FilmMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f FilmFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.FilmMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.FilmMutation", m)
	}
	return f(ctx, mv)
}
...
// The StarshipFunc type is an adapter to allow the use of ordinary
// function as Starship mutator.
type StarshipFunc func(context.Context, *ent.StarshipMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f StarshipFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.StarshipMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.StarshipMutation", m)
	}
	return f(ctx, mv)
}
